          ...
          <div className={styles.gallery_container}>
            <div className={styles.gallery_wrapper}>
              <div className={styles.gallery_text}>
                ...
                <p>
                  Step inside our virtual gallery to experience the magic of Echo, a photo studio
                  that goes beyond the ordinary, transforming moments into timeless works of art.
                </p>
              </div>
